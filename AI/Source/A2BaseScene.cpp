...
void A2BaseScene::RenderWorldWithFog()
{
    const int radius = 3;
...
void A2BaseScene::RenderCourseLine(const std::vector<vec2>& course)
{
}

void A2BaseScene::MoveCamera(const Vector3& offset)
{
...
vec2 A2BaseScene::GetMousePosition()
{
...
unsigned A2BaseScene::LoadAnyKindOfImageAtAllFromTheImagesFolderInTheProjectFiles(const char* file)
{
...
void A2BaseScene::Update(double deltaTime)
{
...
void A2BaseScene::Render()
{
    SceneBase::Render();
    glDisable(GL_DEPTH_TEST);
}

void A2BaseScene::Exit()
{
    SceneBase::Exit();
    delete _square;
}

A2BaseScene::A2BaseScene(): _basePlayerAP(0)
{
}
