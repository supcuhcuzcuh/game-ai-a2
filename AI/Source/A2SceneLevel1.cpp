...
// TODO
bool A2SceneLevel1::PlayerLostDecision()
{
    return false;
}

void A2SceneLevel1::OnPlayerLost()
{
}

void A2SceneLevel1::PlayerDecision()
{
...
void A2SceneLevel1::OnMobTouchedPlayer()
{
}

void A2SceneLevel1::Init()
{
    A2BaseScene::Init();

    // Load Textures
    groundTexture = LoadAnyKindOfImageAtAllFromTheImagesFolderInTheProjectFiles("Image/ground.jpg");
    wallTexture = LoadAnyKindOfImageAtAllFromTheImagesFolderInTheProjectFiles("Image/wall.jpg");
    ...
    WorldTile grassTile;
    grassTile.texture = groundTexture;
    grassTile.entity = nullptr;
    WorldTile wallTile;
    wallTile.texture = groundTexture;
...
void A2SceneLevel1::Update(double deltaTime)
{
...
void A2SceneLevel1::Exit()
{
    A2BaseScene::Exit();
}

A2SceneLevel1::A2SceneLevel1()
{
}
