...
// TODO
bool A2SceneLevel2::PlayerLostDecision()
{
    return false;
}

void A2SceneLevel2::OnPlayerLost()
{
}

void A2SceneLevel2::PlayerDecision()
{
...
void A2SceneLevel2::OnMobTouchedPlayer()
{
}
...
void A2SceneLevel2::Init()
{
    ...
    _world = World("maps/secondlevel.csv",20,20, lookup);
...
void A2SceneLevel2::Update(double deltaTime)
{
    ...
    {
        Application::QueueChangeScene(new A2SceneLevel3);
